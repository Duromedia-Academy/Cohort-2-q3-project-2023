...
const Header = () => {
  ...
  <li className=' px-2 py-5'><Link to="/AllFeatures" className='hover:text-goal'>All Features</Link></li>
    ...
    <li><Link to="/Courses"  className='hover:text-goal'>Courses</Link></li> 
    <li><Link to="/Online" className='hover:text-goal'>Online</Link></li> 
    <li><Link to="/OnSight" className='hover:text-goal'>On-Sight</Link></li> 
  ...
  <li className=' px-2 py-5'><Link to="/AllFeatures" className='hover:text-goal'>All Features</Link></li>
    ...
    <li onClick={() => setIsMenuToggled(!isMenuToggled)}><Link to="/Courses"  className='hover:text-goal'>Courses</Link></li> 

    <li onClick={() => setIsMenuToggled(!isMenuToggled)}><Link to="/Online" className='hover:text-goal'>Online</Link></li> 
    
    <li onClick={() => setIsMenuToggled(!isMenuToggled)}><Link to="/OnSight" className='hover:text-goal'>On-Sight</Link></li> 
