    ...
    return (
        ...
        <div className=" flex items-center justify-between gap-20 px-[5%] border-b border-black h-16">
            ...
            <div className=" flex items-center font-semibold">
                ...
                <div className=" bg-[#1b4942] flex justify-between text-white px-[5%] py-[1.5%] basis-1/2">
                    <div className="">
                        <h1 className=" text-6xl font-medium">Blog Home</h1>
                    </div>
                    <div className="">
                        <ul className=" flex flex-col gap-5">
                            <li className=" hover:underline">Grow your team</li>
                            <li className=" hover:underline">Small business finance</li>
                            <li className=" hover:underline">Taxes and payments</li>
                        </ul>
                    </div>
                    ...
                    <div className=" w-60">
                        ...
                        <div className="">
                            <li className=" hover:underline">How to create a membership website around your course</li>
                        </div>
                    </div>
                    <div className=" w-60">
                        <img className="" src={blogImage} alt="" />
                ...
                <div className=" bg-black bg-blend-overlay basis-1/2 opacity-20"  onMouseEnter={() => !toggleNav(0)}>
                ...
                <div className="transition duration-500 ease-in">
                <div className=" absolute w-full left-0 right-0 h-screen flex flex-col">
                <div className=" bg-[#1b4942] flex justify-between text-white px-[5%] py-[1.5%]">
                    <div className="">
                    ...
                    <div className=" w-72">
                        <img className="" src={blogImage} alt="" />
                        <div className="">
                            <li className=" hover:underline">A step-by-step guide on how to become an online tutor</li>
                        </div>
                    </div>
                    </div>
                </div>
                <div className=" bg-black bg-blend-overlay basis-1/2 opacity-20"  onMouseEnter={() => !toggleNav(1)}>
                ...
                <div className=" bg-[#1b4942] flex justify-between text-white px-[5%] py-[1.5%]">
                    <div className="">
                        <h1 className=" text-6xl font-medium">Creativity</h1>
                    </div>
                    <div className="">
                        <ul className=" flex flex-col gap-5">
                            <li className=" hover:underline">Grow your team</li>
                ...
                <div className=" bg-black bg-blend-overlay basis-1/2 opacity-20"  onMouseEnter={() => !toggleNav(2)}>
                ...
                <div className=" bg-black bg-blend-overlay basis-1/2 opacity-20"  onMouseEnter={() => !toggleNav(3)}>
                ...
                <div className=" bg-black bg-blend-overlay basis-1/2 opacity-20"  onMouseEnter={() => !toggleNav(4)}>
                ...
                <div className=" bg-black bg-blend-overlay basis-1/2 opacity-20"  onMouseEnter={() => !toggleNav(5)}>
            ...
            <div className=" flex items-center">
                <div className=" border-x border-black">
                    <div className=" lg:p-6 p-3 py-6 cursor-pointer" onClick={searchOpen}>
                    <IoSearchOutline className={` text-xl ${isSearchClicked ? 'hidden' : 'block'}`} />
                    </div>
                    ...
                    <form className="">
                        ...
                        <span><IoSearchOutline onClick={searchOpen} className=" absolute left-5 top-2 text-xl cursor-pointer" /></span>
                        <input type="text" className=" md:w-[500px] lg:w-[600px] bg-transparent px-7 py-2 outline-none border-b-2 border-black" required/>
                        
                        <div className=" absolute right-5 flex gap-3 top-2 text-xl">
                        <span className=" text-xl cursor-pointer" onClick={searchClosed}><AiOutlineClose /></span>
                        <button type="submit" className=" text-xl cursor-pointer"><AiOutlineArrowRight /></button>
                        </div>
        ...
        <div className={`${background} px-[5%]`}>
           <div className=" flex justify-between items-center">
                ...
                <div className=" flex gap-5 items-center">
                    ...
                    <div className="hamburger flex flex-col gap-2 border-l border-black py-6 pl-4 cursor-pointer" onClick={menuOpen}>
                        <span className={`bar block h-0.5 w-6 text-black bg-black duration-150 ease-in transition-all ${isMobileNav ? 'opacity-100 translate-y-[9.7px] rotate-45' : '' }`}></span>

                        <span className={`bar h-0.5 w-6 text-black bg-black block duration-150 ease-in transition-all ${isMobileNav ? 'opacity-0' : 'opacity-100'}`}></span>

                        <span className={`bar h-0.5 w-6 text-black bg-black block duration-150 ease-in transition-all${isMobileNav ? 'opacity-100 translate-y-[-9.7px] -rotate-45' : ''}`}></span>
                    </div>
        ...
        <div className={`bg-[#1b4942] py-5 px-[5%] transition-height duration-500 ease-in fixed w-full z-10 ${!isSearchClickedMobile ? 'right-[-100%]' : 'right-[0]'}`} >
        <form className="">
                        <div className=" relative top-1">
                        <div className=" flex justify-between items-center">
                        <span><IoSearchOutline className=" absolute left-2 top-2 text-xl cursor-pointer text-white" /></span>
                        <input type="text" className=" w-full bg-transparent px-8 py-2 outline-none border-b-2 border-white text-white" required/>
                        
                        <div className=" absolute right-2 flex gap-3 top-2 text-xl">
                        <button type="submit" className=" text-xl cursor-pointer text-white"><AiOutlineArrowRight /></button>
                        </div>
        ...
        <div className={`bg-[#1b4942] py-5 transition-height duration-500 ease-in fixed w-full h-screen overflow-y-hidden ${!isMobileNav ? 'right-[-100%]' : 'right-[0]'}`} >
        <div className="">
        <form className="px-[5%]">
                        <div className=" relative top-1">
                        <div className=" flex justify-between items-center">
  ...
  <div className=" w-full mx-auto overflow-hidden">
    ...
    >
      ...
      <div
       ...
       style={
        accordionStates[0] ? { height: contentEl1.current.scrollHeight } : { height: 0}
       }>
        <div className="">
      </div>
   </div>
  ...
  <div className=" w-full mx-auto overflow-hidden text-white">
    ...
    >
      ...
      <div
        ...
        style={
          accordionStates[1] ? { height: contentEl2.current.scrollHeight } : { height: 0}
         }>
  ...
  <div className=" w-full mx-auto overflow-hidden text-white">
    ...
    >
      ...
      <div
        ...
        className="px-4 transition-height duration-500 ease-in-out h-0"
        style={
          accordionStates[2] ? { height: contentEl3.current.scrollHeight } : { height: 0}
         }
      >
            <ul className=' py-5 text-xl pl-10 flex flex-col gap-3 pt-3'>
              <li>Grow your team</li>
  ...
  <div className=" w-full mx-auto overflow-hidden list-disc text-white">
    ...
    >
      ...
      <div
        ...
        className="px-4 transition-height duration-500 ease-in-out h-0"
        style={
          accordionStates[3] ? { height: contentEl4.current.scrollHeight } : { height: 0}
         }
      >
            <ul className=' py-5 text-xl pl-10 flex flex-col gap-3 pt-3'>
              <li>Grow your team</li>
    ...
    >
      ...
      <div
        ...
        className="px-4 transition-height duration-500 ease-in-out h-0"
        style={
          accordionStates[4] ? { height: contentEl5.current.scrollHeight } : { height: 0}
         }
      >
            <ul className=' py-5 text-xl pl-10 flex flex-col gap-3 pt-3'>
              <li>Grow your team</li>
    ...
    >
      ...
      <div
        ...
        className="px-4 transition-height duration-500 ease-in-out h-0"
        style={
          accordionStates[5] ? { height: contentEl6.current.scrollHeight } : { height: 0}
         }
      >
            <ul className=' py-5 text-xl pl-10 flex flex-col gap-3 pt-3'>
              <li>Grow your team</li>
        ...
        <div className=" border-t border-black flex absolute w-full left-0 bottom-0 z-[1] h-28 top-[72%]">
            <button className="bg-[#1b4942] basis-1/2 font-semibold text-white text-2xl">Join for free</button>
