      ...
      <div className="border-b max-w-[750px] w-full mx-auto overflow-hidden list-disc">
        ...
        >
          ...
          <div className=" basis-1/2 h-[370px] flex flex-col justify-around">
            <p>
              Learn the skills and tools you need to build engaging, interactive user experiences on
              the web as a front-end web developer. If you would like to get started as a front-end web
              developer, This course is for you! Work on projects ranging from a simple HTML page to a
              complete full-blown project.
            </p>

            <p className="">
              This course teaches you the skills you need to build engaging, interactive user experiences
              on the web as a front-end web developer. This course path will guide you through all you
              need to know to start a career as a Frontend Engineer from the ground up.
            </p>
          </div>
          </div>
      </div>
        ...
        >
          ...
          <div
            ...
            style={
              ...
              <ul className=' py-5'>
                <li className=' list-disc ml-6'>The Front-end Web Development Path will guide you through what you need to know to start a career as a Front-end Engineer from the ground up.You will learn;</li>
        ...
        >
          ...
          >
            ...
            <ul className=" list-disc ml-10 flex flex-col gap-3 pt-3 text-lg">
                <li><b>Week 1:</b> Introduction to Web Development/HTML</li>
                <li><b>Week 2:</b> Styling HTML Web Pages</li>
                <li><b>Week 3:</b> Intermediate CSS</li>
                <li><b>Week 4:</b> Bootstrap and Responsive Design</li>
                <li><b>Week 5:</b> JavaScript Fundamentals and DOM</li>
                <li><b>Week 6:</b> JavaScript Fundamentals and DOM (II)</li>
                <li><b>Week 7:</b> ES6 and JavaScript Modules</li>
                <li><b>Week 8:</b> Project Week <br />
                      Build a one-page website with Html, CSS, and Javascript</li>
                <li><b>Week 9:</b> React – Getting Started</li>
                <li><b>Week 10:</b> React – (ii) <br />
                    Single Page Applications (SPAs) with React</li>
                <li><b>Week 11:</b> React (iii) <br />
                      Advanced Components</li>
                <li><b>Week 12</b> – React (iv) <br />
                      Using the Switch Tag</li>
