    ...
    <div>
          ...
          <div className=' grid grid-cols-1 lg:grid-cols-2 lg:h-screen '>
            <div className=' flex items-center'>
              <div className=' max-w-[520px] md:max-w-[750px]  lg:max-w-[520px] m-auto px-5   md:px-0 py-12 lg:py-0  text-white'>
                <h2 className=' text-3xl md:text-4xl lg:text-[2.9rem]  lg:leading-[3.5rem]'>The best online course platform for creators, coaches, and teachers.</h2>
                <h3 className=' py-8 text-xl'>Online courses are an engaging way to scale your digital business and build a lasting source of income.</h3>
                <div>
                  <div>
                    <form >
                      ...
                      <div className=' flex flex-col md:flex-row gap-6 pt-2'>
                        ...
                        <div>
                          <button className=' bg-goal py-4 w-full md:px-6  rounded-md'>
                            <a href="#/" className=' text-[1.1rem] text-black'>Join for free</a>
                          </button>
                        </div>
                      </div>
                    </form>
                  </div>
                  <p className=' lg:max-w-[300px] text-[0.8rem] pt-2'>*By submitting your email address, you agree to Teachable's <a href="#/" className=' underline'>Terms of use</a> and <a href="#/" className=' underline'>Privacy Policy.</a></p>
                </div>
              </div>
            </div>
            <div>
      ...
      <section className=' two'>
        <div className=' py-24 lg:py-36 bg-cream'>
          <div className=' text-center  max-w-[350px] md:max-w-[700px] lg:max-w-no m-auto'>
            <h2 className=' text-3xl md:text-4xl lg:text-5xl font-[350]'>Own your content and get paid—on your own terms</h2>
            <h3 className=' lg:text-xl py-12'>Enrich your online business with high-value virtual coaching products. Host private or small group coaching sessions in three simple steps.</h3>
          </div>
          <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  lg:max-w-no m-auto place-items-center lg:place-items-start  md:max-w-[750px] gap-6 px-4  md:px-0'>
            <div className=' max-w-[350px]'>
              ...
              <h4 className=' text-[0.9rem] md:text-[1rem]'>Start building your school and course in minutes with our no-code course builder.</h4>
            </div>
            <div className=' max-w-[350px]'>
              <h2 className=' border-b-2 border-black pb-2'>Step 2</h2>
              <h3 className=' py-8 text-xl md:text-2xl'>Upload your content</h3>
              <h4 className=' text-[0.9rem] md:text-[1rem]'>Our simple drag-and-drop builder lets you upload videos, audio, templates, guides, and more. It's your content, your way.</h4>
            </div>
            <div className=' max-w-[350px]'>
              <h2 className=' border-b-2 border-black pb-2'>Step 3</h2>
              <h3 className=' py-8 text-xl md:text-2xl'>Beautify and brand your school</h3>
              <h4 className=' text-[0.9rem] md:text-[1rem]'>Add a personal touch with our easy-to-use customizations—no tech skills necessary.</h4>
            </div>
          </div>
        </div>
      </section>
      <section className=' three'>
        <div className=' py-10 lg:py-20 bg-brown text-white '>
          <div className=' text-center px-5 lg:px-0 lg:max-w-nice m-auto'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl'>Creator-first features</h2>
            <h3 className=' text-[1.15rem] py-12'>Creating and selling online is easy when you have best-in-class features and course creation tools for every type of creator need.</h3>
          </div>
          <div className=' max-w-no m-auto px-5 lg:px-0'>
            <div className=' flex flex-col md:flex-col-reverse lg:flex-row justify-around items-center pb-16'>
              <div className=' pt-8'>
                <img src={pic80} alt="" className=' w-[520px] md:w-[680px] lg:w-[520px]' />
              </div>
              <div className=' max-w-[520px] md:max-w-[700px] lg:max-w-[460px] pt-8'>
                <h2 className=' text-2xl'>More than a payment gateway</h2>
                <h3 className=' text-[1.15rem] pt-3 pb-6'>Teachable:pay is an automated way to get paid, manage payouts, and sell more confidently. Get a simple, reliable checkout system, fraud protection, tax-inclusive pricing, global currency conversion, automatic payouts, and more. Plus, enjoy zero transaction fees on Pro and Business plans. </h3>
                <h2 className=' text-2xl'>Flexibility at your fingertips</h2>
                <h3 className=' text-[1.15rem] pt-3 pb-6'>Our effortless course builder and customizable templates mean you can personalize your course to align with your style and branding. Course creators also have the flexibility to utilize various forms of multimedia, including audio, video, images, and text to adapt to different learning styles.</h3>
              </div>
            </div>
            <div className=' flex flex-col lg:flex-row justify-around items-center'>
              <div className=' lg:max-w-[460px]  md:max-w-[700px] max-w-[520px] pb-8'>
                ...
                <h3 className=' text-[1.15rem] pt-3 pb-6'>The tools you know and love, in one place, working together for you. Third-party integrations, such as MailChimp, Zapier, ConvertKit, Google Analytics, Aweber, and Segment are compatible with our platform, and our public API will automate your workflow.</h3>
                <h2 className=' text-2xl'>Powerful innovations</h2>
                <h3 className=' text-[1.15rem] pt-3 pb-6'>Our best-in-class features were designed with creators like you in mind. Use our powerful AI course curriculum generator to kickstart an idea, inspire creativity, or unblock yourself. Work smarter, not harder—we’ll show you how.</h3>
              </div>
              <div>
                <img src={pic81} alt="" className='  w-[520px] md:w-[680px] lg:w-[520px]' />
              </div>
            </div>
            <div className=' flex flex-col md:flex-col-reverse lg:flex-row justify-around items-center pb-16'>
              <div className=' pt-8'>
                <img src={pic82} alt="" className=' w-[520px] md:w-[680px] lg:w-[520px]' />
              </div>
              <div className=' max-w-[520px] md:max-w-[700px] lg:max-w-[460px] pt-8'>
                <h2 className=' text-2xl'>Growth made easy </h2>
                <h3 className=' text-[1.15rem] pt-3 pb-6'>Scale and market your course with our advanced data reporting and business management features. Get support selling your course with our affiliate marketing capabilities, automated payouts, and referral programs. </h3>
                <h2 className=' text-2xl'>Meaningful audience engagement</h2>
                <h3 className=' text-[1.15rem] pt-3 pb-6'>Build—and sustain—impactful relationships with your audience. Bespoke student-side features like comments, quizzes, and certifications of completion drive learning outcomes and student satisfaction.</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className=' four'>
        <div className=' bg-goal py-12 lg:py-24'>
          <div className=' text-center text-brown ma-w-[520px] lg:max-w-no px-6 m-auto'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl font-[400]'>Get started today</h2>
            <h3 className=' text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] pt-6 font-[600]'>Our all-star features make creating a course, connecting to your audience, and watching your online business grow seamless.</h3>
      ...
      <section className='five'>
        <div className=' py-8 lg:py-24 bg-cream'>
          <div className=' text-center md-max-w-[700px] lg:max-w-yh max-w-[500px] m-auto px-5 md:px-0'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl'>Course creator spotlight</h2>
            <h3 className=' py-8 lg:py-16 lg:text-xl'>Get inspiration from members of the Teachable community and discover their online courses.</h3>
          </div>
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-nice lg:max-w-no m-auto gap-12 place-items-center px-6">
            <div className=" max-w-[360px]  h-full bg-white ">
              ...
              <div className=" relative bottom-[10px]  px-4 gap-6 pt-4">
                <a href="#/" className=' underline'>See it in action</a>
              </div>
            </div>
      ...
      <section className='seven'>
        <div className=" bg-lemon">
          <div className=' text-center text-brown ma-w-[520px] lg:max-w-yh px-6 m-auto'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl font-[400]'>Resources for coaches of all levels</h2>
            <h3 className=' text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] pt-6 font-[600]'>No matter where you are in your coaching journey, we can offer support.</h3>
          </div>
          <Swiper
      ...
      <section className=' eight'>
        <div className=' bg-goal py-12 lg:py-24 text-brown'>
          <div className=' text-center text-brown ma-w-[520px] lg:max-w-yh px-6 m-auto'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl font-[400]'>Create your online course</h2>
            <h3 className=' text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] pt-6 font-[600]'>Get started building or scaling the online business of your dreams.</h3>
            <div className=' pt-8 lg:pt-16'>
              <button className=' bg-brown text-white py-3 px-6 lg:px-8 rounded-md'>
                <a href="#/">Start for free</a>
              </button>
