  ...
  return (
      ...
      <div className=' grid grid-cols-1 lg:grid-cols-2 lg:h-screen '>
        <div className=' flex items-center'>
              <div className=' max-w-[520px] md:max-w-[750px]  lg:max-w-[520px] m-auto px-5   md:px-0 py-12 lg:py-0  text-white'>
                <h2 className=' text-3xl md:text-4xl lg:text-[2.9rem]  lg:leading-[3.5rem]'>The best online coaching platform to support your audience</h2>
                <h3 className=' py-8 text-xl'>Add more value to your online business through professional one-on-one or small group coaching.</h3>
                <div>
                  <div>
                    <form >
   ...
   <section className=' two'>
      <div className=' py-24 lg:py-36 bg-cream'>
          <div className=' text-center  max-w-[350px] md:max-w-[700px] lg:max-w-no m-auto'>
            <h2 className=' text-3xl md:text-4xl lg:text-5xl font-[350]'>Easily create a digital coaching business</h2>
        ...
        <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  lg:max-w-no m-auto place-items-center lg:place-items-start  md:max-w-[750px] gap-6 px-4  md:px-0'>
          <div className=' max-w-[350px]'>
              ...
              <h3 className=' py-8 text-xl md:text-2xl'>Create your coaching product</h3>
              <h4 className=' text-[0.9rem] md:text-[1rem]'>Create, sell, and manage all aspects of your coaching business on Teachable. Sell your digital coaching services solo or alongside your course or digital download.</h4>
          </div>
            <div className=' max-w-[350px]'>
              <h2 className=' border-b-2 border-black pb-2'>Step 2</h2>
              <h3 className=' py-8 text-xl md:text-2xl'>Upload your content</h3>
              <h4 className=' text-[0.9rem] md:text-[1rem]'>Customize content based on your audience’s needs. Create milestones, schedule meetings, set-up video calls, send messages and files, and more with coaching at Teachable.</h4>
          </div>
            <div className=' max-w-[350px]'>
              <h2 className=' border-b-2 border-black pb-2'>Step 3</h2>
              <h3 className=' py-8 text-xl md:text-2xl'>Customize and sell</h3>
              <h4 className=' text-[0.9rem] md:text-[1rem]'>Offer a professional learning experience to your audience with our easy-to-use, customizable sales page.</h4>
          </div>
        </div>
      </div>
   </section>
   <section className=' three'>
     <div className=' py-10 lg:py-20 bg-gap text-white'>
          <div className=' text-center px-5 lg:px-0'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl'>Features for all types of coaching</h2>
            <h3 className=' text-[1.15rem] py-12'>Building or scaling your online business is easy with these convenient coaching tools.</h3>
      </div>
      <div className=' max-w-no m-auto px-5 lg:px-0'>
        <div className=' flex flex-col md:flex-col-reverse lg:flex-row justify-around items-center pb-16'>
          <div className=' pt-8'>
            <img src={pic71} alt=""  className=' w-[520px] md:w-[680px] lg:w-[520px]'/>
          </div>
          <div className=' max-w-[520px] md:max-w-[700px] lg:max-w-[460px] pt-8'>
                ...
                <h3 className=' text-[1.15rem] pt-3 pb-6'>Our effortless drag-and-drop builder and customizable templates mean you can personalize your coaching products to align with your style and branding. Plus, you can easily manage, send assignments and files, schedule appointments, and keep your clients on track with their goals.</h3>
          </div>
        </div>
        <div className=' flex flex-col lg:flex-row justify-around items-center'>
              <div className=' lg:max-w-[460px]  md:max-w-[700px] max-w-[520px] pb-8'>
                <h2 className=' text-2xl'>Scale made easy</h2>
                <h3 className=' text-[1.15rem] pt-3 pb-6'>With an average price of over $200, digital coaching services are a powerful way to grow your revenue alongside your course or digital downloads. Our built-in upsell and order bump features allow you to market your services to maximize your earning potential.</h3>
                <h2 className=' text-2xl'>Coach with care</h2>
                <h3 className=' text-[1.15rem] pt-3 pb-6'>Who and how you coach is up to you. Our customizable intake block and page editor give you the power to control who you onboard as a client. Deepen your audience experience and coach on your terms.</h3>
          </div>
          <div>
                <img src={pic72} alt="" className='  w-[520px] md:w-[680px] lg:w-[520px]' />
          </div>
        </div>
      </div>
     </div>
   ...
   <section className=' four'>
      <div className=' bg-goal py-12 lg:py-24'>
        <div className=' text-center text-gap ma-w-[520px] lg:max-w-yh px-6 m-auto'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl font-[400]'>Start coaching online today</h2>
            <h3 className=' text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] pt-6 font-[600]'>Our best-in-class features make creating, selling, and managing your coaching business a breeze.</h3>
   ...
   <section className='five'>
     <div className=' py-8 lg:py-24 bg-cream'>
      <div className=' text-center md-max-w-[700px] lg:max-w-yh max-w-[500px] m-auto px-5 md:px-0'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl'>Coach spotlight</h2>
            <h3 className=' py-8 lg:py-16'>Meet some professional coaches within the Teachable community and explore their online coaching businesses.</h3>
      </div>
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-nice lg:max-w-no m-auto gap-12 place-items-center px-6">
            <div className=" max-w-[360px]  h-full bg-white ">
              ...
              <div className=" px-4">
                ...
                <p className=" pb-24">
                  Greg started out as a personal trainer, but knew he didn’t want to stop there. With his experience as a trainer and researcher, he launched a fitness course online.m.
                </p>
              </div>
   ...
   <section className='seven'>
      ...
      <section className=' eight'>
        <div className=' bg-goal py-12 lg:py-24'>
          <div className=' text-center text-brown ma-w-[520px] lg:max-w-yh px-6 m-auto'>
            <h2 className=' text-2xl md:text-3xl lg:text-5xl font-[400]'>Create your professional coaching product</h2>
