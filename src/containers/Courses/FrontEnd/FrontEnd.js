        ...
        <div className="">
            ...
            <div className=" bg-[#1db954]">
                ...
                <div className=" flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="">
                    <button className=" bg-white py-1 rounded font-semibold px-4">On Sight</button>
                    </div>
                    <h1 className=" text-3xl lg:text-6xl font-semibold">Frontend Web Development with React JS</h1>
                    <p className="">Start off your career today as a Front-End Web Developer. Learn to build high quality websites with dynamic applications to create stunning user experiences for the web.</p>
                    <div className=" flex flex-col md:flex-row gap-3">

                        <div className="">
                        <button className=" bg-[#17355c] font-bold text-white px-7 py-3 shadow-xl rounded-md hover:shadow-none ease-in duration-200">Apply Now</button>
                        </div>

                        <div className="">
                        <button className=" bg-white font-bold px-4 py-3 shadow-xl rounded-md hover:shadow-none ease-in duration-200">Speak To a Learning Advisor</button>
                        </div>
                    </div>
                    ...
                    <div className=" basis-1/2">
                        <img src={frontEnd} className=" h-[400px] lg:h-[600px] rounded-lg object-cover" alt="" />
                    </div>
                </div>
                </div>
            </div>
            ...
            <section className=" bg-[#e4f0ee] py-[7%] px-[5%] text-[#17355c]">
                ...
                <div className=" flex gap-3 pt-20 justify-center">
                    ...
                    <div className="">
                    <button className=" bg-white font-bold px-4 py-3 shadow-xl rounded-md hover:shadow-none ease-in duration-200">Download syllabus</button>
                    </div>
                </div>
            </section>
            ...
            <div className=" bg-white px-[5%] py-32 text-[#17355c]">
                ...
                <h1 className=" text-center font-semibold text-4xl pb-20">Come with expectations</h1>
            ...
            <div className=" flex flex-col items-center justify-center text-center">
                ...
                <div className=" leading-5 text-center pt-3">
                    <p>You’ll be taught and mentored by some of the best teachers in the industry.</p>
                </div>
            </div>
            ...
            <div className=" flex flex-col items-center justify-center text-center">
                ...
                <div className=" leading-5 text-center pt-3">
                    <p>Get your very own physical certificate to prove your participation</p>
                </div>
            </div>
            ...
            <div className=" flex flex-col items-center justify-center text-center">
                ...
                <div className=" leading-5 text-center pt-3">
                    <p>Become part of an ever-growing, supportive community of like minds</p>
                </div>
            </div>
            ...
            <div className=" flex flex-col items-center justify-center text-center">
                ...
                <div className=" leading-5 text-center pt-3">
                    <p>Our classes and the environment is serene and conducive for learning.</p>
                </div>
            </div>
            ...
            <div className=" flex flex-col items-center justify-center text-center">
                ...
                <div className=" leading-5 text-center pt-3">
                    <p>You will get a free t-shirt, jotter, pen etc. This is to make you feel right at home, cause why not?!</p>
                </div>
            </div>
            ...
            <section className=" bg-[#17355c] text-center px-[5%] ">
                ...
                <h1 className=" text-4xl font-semibold">Frontend Web Development with React JS</h1>

                <p className=" py-5">Start off your career today as a Front-end web developer, learn to build high quality websites with dynamic applications to create stunning user experiences for the web.</p>

                <div className=" flex flex-col md:flex-row gap-5 justify-center">
                    <div className="">
                    <button className=" bg-[#1db954] font-bold text-white px-7 py-3 shadow-xl rounded-md hover:shadow-none ease-in duration-200">Apply Now</button>
                    </div>
