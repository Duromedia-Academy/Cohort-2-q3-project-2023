...
const faqData = [
  {
    ...
    answer:
      "Our program is 100% online, Live training program within the comfort of your home. However, if you are interested in our physical program, pls message",
    img: { frontend },
  },
  {
    question: "What is the duration for a typical program?",
    answer:
      "A typical program at Duromedia runs for 3 Months, while our Fullstack program runs for 6 Months.",
  },
  {
    question: "Where are you located?",
    answer:
      "Plot 12, Oladele Kadiri Close, off Nob-Oluwa Street, Ogba , Ikeja. Lagos Nigeria.",
  },
  {
